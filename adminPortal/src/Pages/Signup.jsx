    ...
    return (
        <>
            <div className="flex items-center justify-center h-screen my-10">
                <div className="relative flex flex-col justify-center text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
                    ...
                    <form className="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
                        <div className="flex flex-col gap-6 mb-1">
                            ...
                            <div className="relative h-11 w-full min-w-[200px]">
                                <input placeholder="star cinema"
                                    value={name}
                                    onChange={handleNameChange}
                                    className="peer h-full w-full rounded-md border border-blue-gray-200  !border-t-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus: focus:!border-t-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50" />
                                <label
                            ...
                            <div className="relative h-11 w-full min-w-[200px]">
                                <input placeholder="anand vihar, delhi"
                                    value={address}
